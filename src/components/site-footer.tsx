      ...
      <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[1.7fr_1fr_1fr]">
        <div>
          ...
          <p className="max-w-sm text-sm text-foreground">
            Một ý tưởng khởi nghiệp của sinh viên IUH: thời trang cá nhân hóa
            với AI concept và virtual try-on.
          </p>
        </div>
        <div>
          <p className="mb-4 text-[0.68rem] uppercase tracking-[0.18em] text-primary">
            Khám phá
          </p>
