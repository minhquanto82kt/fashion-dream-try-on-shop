export type Product = {
  ...
  price: number; // VND
  category:
    "hoodies" | "tees" | "outerwear" | "accessories" | "cap" | "sunglass";
  image: string;
  gallery: string[];
  sizes: string[];
  colors: string[];
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    badge: "Best seller",
    description:
      "Set áo khoác + quần ống suông tối giản, phối cùng nhau hoặc tách rời đều chất.",
  },
  {
    ...
    description:
      "Áo khoác shell chống gió nhẹ, seam dán, túi hộp lớn — layer cuối cùng bạn cần.",
  },
  {
    id: "beanie-mono",
    name: "Beanie Mono",
    ...
    description:
      "Beanie len tăm, thêu logo chìm. Món phụ kiện làm gọn mọi outfit.",
  },
  {
    ...
    colors: ["Black"],
    description:
      "Túi đeo chéo vải cordura, 3 ngăn, dây bản to điều chỉnh nhanh.",
  },
  {
    id: "cargo-wide-pant",
    ...
    colors: ["Cement", "Moss"],
    description:
      "Quần cargo ống rộng, túi hộp gập, lai bo dây rút — thoải mái từ giảng đường ra phố.",
  },
  {
    id: "campus-crewneck",
  ...
  },
  {
    ...
    badge: "New accessory",
    description:
      "Mũ lưỡi trai cotton 6 mảnh, logo thêu nổi và khóa điều chỉnh phía sau.",
  },
  {
    id: "shade-runner",
    name: "Shade Runner",
    ...
    colors: ["Black"],
    description:
      "Kính râm gọng vuông nhẹ, tròng tối và thiết kế gọn cho mọi outfit.",
  },
];
