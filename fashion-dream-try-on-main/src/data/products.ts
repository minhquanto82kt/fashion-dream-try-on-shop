...
/**
 * @deprecated Transitional storefront fallback only.
 * Canonical runtime catalogue is Supabase + Product Domain.
 * New production code must use src/lib/product.functions.ts.
 */
export type Product = {
  id: string;
  name: string;
...
/** @deprecated Do not add or edit runtime products here. */
export const PRODUCTS: Product[] = [
  ...
  { id: "campus-crewneck", name: "Campus Crewneck", price: 890000, category: "hoodies", image: px("15213195"), gallery: [px("15213195"), px("774909")], sizes: ["S", "M", "L", "XL"], colors: ["Beige", "Charcoal"], badge: "IUH edition", description: "Sweater cổ tròn, form vừa, mặc quanh năm." },
...
/** @deprecated Use getPublishedProduct from product.functions.ts. */
