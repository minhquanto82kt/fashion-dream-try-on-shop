        ...
        <div className="flex items-end justify-between gap-4">
          ...
          {items.length > 0 && (
            <button
              type="button"
              onClick={handleClear}
              className="flex items-center gap-2 border border-border px-4 py-2 text-xs uppercase tracking-[0.15em] text-silver transition-colors hover:border-destructive hover:text-destructive"
            >
