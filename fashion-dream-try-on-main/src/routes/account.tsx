  ...
  return (
    <main className="account-page">
      <style>{`
        ...
        .account-page{--cream:#f7f1e7;--orange:#f0a500;--red:#e45826;--ink:#1b1a17;--panel:rgba(27,26,23,.86);position:fixed;inset:0;overflow:auto;background-image:linear-gradient(135deg,rgba(27,26,23,.84),rgba(48,37,26,.58) 58%,rgba(27,26,23,.86)),url('/account/account-background.png');background-size:cover;background-position:center;background-repeat:no-repeat;color:var(--cream);font-family:inherit;isolation:isolate}.account-page *{box-sizing:border-box}.account-loading{min-height:100dvh;display:grid;place-items:center;color:var(--orange);font:800 9px Arial,sans-serif;letter-spacing:.22em}.account-shell{position:relative;z-index:2;width:min(1180px,calc(100vw - 48px));min-height:100%;margin:auto;padding:24px 0;display:flex;flex-direction:column}.account-top{display:flex;align-items:center;justify-content:space-between;gap:20px}.account-brand,.account-back{color:var(--cream);text-decoration:none}.account-brand{display:flex;align-items:center;gap:10px}.account-mark{display:grid;place-items:center;width:30px;height:30px;background:var(--orange);color:var(--ink);font-weight:900}.account-brand strong{font-size:18px;letter-spacing:.1em}.account-brand small{display:block;color:var(--orange);font-size:7px;letter-spacing:.18em;margin-top:2px}.account-back{display:flex;align-items:center;gap:7px;color:rgba(247,241,231,.65);font:700 8px Arial,sans-serif;letter-spacing:.16em;text-transform:uppercase}.account-back:hover{color:var(--orange)}.account-main{flex:1;display:flex;align-items:center;padding:36px 0}.account-auth-grid{width:100%;display:grid;grid-template-columns:1fr 1fr;gap:70px;align-items:center}.account-kicker{color:var(--orange);font:800 9px Arial,sans-serif;letter-spacing:.2em}.account-title{margin:12px 0 0;font:900 clamp(58px,8vw,112px)/.82 Arial,sans-serif;letter-spacing:-.055em;text-transform:uppercase}.account-title span{display:block}.account-title .accent{color:var(--orange)}.account-copy{max-width:430px;margin:28px 0 0;color:rgba(247,241,231,.72);font-size:13px;line-height:1.7}.account-index{margin-top:30px;color:rgba(247,241,231,.42);font:800 8px Arial,sans-serif;letter-spacing:.16em;text-transform:uppercase}.account-index b{color:var(--orange);margin-right:12px}.account-card{background:var(--panel);border:1px solid rgba(247,241,231,.18);border-left:3px solid var(--orange);padding:32px;box-shadow:18px 18px 0 rgba(0,0,0,.22)}.account-card-head{display:flex;justify-content:space-between;gap:20px;margin-bottom:22px}.account-kicker-small{color:var(--orange);font:800 8px Arial,sans-serif;letter-spacing:.18em;text-transform:uppercase}.account-card h2{margin:7px 0 0;font:600 30px/1.1 Georgia,serif}.account-number{display:grid;place-items:center;width:32px;height:32px;border:1px solid rgba(240,165,0,.65);color:var(--orange);font:800 8px Arial,sans-serif}.account-switch{display:grid;grid-template-columns:1fr 1fr;border-top:1px solid rgba(247,241,231,.18);border-bottom:1px solid rgba(247,241,231,.18);margin-bottom:24px}.account-switch button{position:relative;padding:12px;border:0;background:transparent;color:rgba(247,241,231,.45);font:800 8px Arial,sans-serif;letter-spacing:.14em;text-transform:uppercase;cursor:pointer}.account-switch button[aria-selected=true]{color:var(--cream)}.account-switch button[aria-selected=true]:after{content:"";position:absolute;left:0;right:0;bottom:-1px;height:2px;background:var(--orange)}.account-google-wrap{display:flex;align-items:center;gap:10px;margin:24px 0 12px;color:rgba(247,241,231,.35);font:700 7px Arial,sans-serif;letter-spacing:.16em;text-transform:uppercase}.account-google-wrap:before,.account-google-wrap:after{content:"";height:1px;flex:1;background:rgba(247,241,231,.15)}.account-socials{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:0}.account-social{width:100%;height:46px;display:flex;align-items:center;justify-content:center;gap:9px;border:1px solid rgba(247,241,231,.22);background:rgba(0,0,0,.16);color:var(--cream);font:800 8px Arial,sans-serif;letter-spacing:.1em;text-transform:uppercase;cursor:pointer}.account-social:hover{border-color:var(--orange);background:rgba(240,165,0,.06)}.account-social img{width:20px;height:20px;display:block;flex:none;object-fit:contain}.account-form{display:flex;flex-direction:column;gap:16px}.account-field{display:flex;flex-direction:column;gap:7px}.account-field label{font:800 8px Arial,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(247,241,231,.68)}.account-field input{height:46px;width:100%;padding:0 12px;border:1px solid rgba(247,241,231,.18);background:rgba(0,0,0,.22);color:var(--cream);outline:none;border-radius:0}.account-field input:focus{border-color:var(--orange)}.account-password{position:relative}.account-password input{padding-right:46px}.account-eye{position:absolute;right:3px;top:3px;width:40px;height:40px;border:0;background:transparent;color:rgba(247,241,231,.55);cursor:pointer}.account-feedback{margin:0;font:9px/1.55 Arial,sans-serif}.account-feedback--error{color:#ffc5a8}.account-feedback--success{color:var(--cream)}.account-submit{min-height:48px;border:0;background:var(--orange);color:var(--ink);font:900 9px Arial,sans-serif;letter-spacing:.16em;text-transform:uppercase;cursor:pointer}.account-submit:disabled{opacity:.55;cursor:wait}.account-resend{border:0;background:transparent;color:var(--orange);font:800 8px Arial,sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;text-align:left}.account-resend:disabled{opacity:.5}.account-dashboard{width:100%}.account-welcome{display:flex;justify-content:space-between;align-items:flex-end;gap:30px;border-bottom:1px solid rgba(247,241,231,.16);padding-bottom:26px}.account-welcome h1{margin:8px 0 0;font:900 clamp(42px,6vw,78px)/.88 Arial,sans-serif;letter-spacing:-.05em;text-transform:uppercase}.account-welcome h1 span{color:var(--orange)}.account-welcome p{max-width:460px;color:rgba(247,241,231,.65);font-size:12px;line-height:1.7}.account-logout{display:inline-flex;align-items:center;gap:7px;border:1px solid rgba(247,241,231,.2);background:transparent;color:rgba(247,241,231,.7);padding:10px 13px;font:800 8px Arial,sans-serif;letter-spacing:.12em;text-transform:uppercase;cursor:pointer}.account-logout:hover{border-color:var(--orange);color:var(--orange)}.account-modules{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-top:18px}.account-module{min-height:150px;padding:20px;border:1px solid rgba(247,241,231,.15);background:rgba(27,26,23,.6);color:var(--cream);text-decoration:none;display:flex;flex-direction:column;justify-content:space-between;transition:.2s}.account-module:hover{transform:translateY(-3px);border-color:rgba(240,165,0,.55);background:rgba(240,165,0,.07)}.account-module-icon{color:var(--orange)}.account-module strong{font-size:13px}.account-module small{display:block;margin-top:6px;color:rgba(247,241,231,.45);font:800 7px Arial,sans-serif;letter-spacing:.12em;text-transform:uppercase}.account-profile{margin-top:18px;display:grid;grid-template-columns:1.3fr .7fr;gap:12px}.account-profile-card{padding:20px;border:1px solid rgba(247,241,231,.15);background:rgba(27,26,23,.6)}.account-profile-card h3{margin:0 0 16px;color:var(--orange);font:800 8px Arial,sans-serif;letter-spacing:.16em;text-transform:uppercase}.account-profile-row{display:flex;justify-content:space-between;gap:20px;padding:10px 0;border-bottom:1px solid rgba(247,241,231,.08);font-size:12px}.account-profile-row:last-child{border-bottom:0}.account-profile-row span{color:rgba(247,241,231,.45)}.account-note{color:rgba(247,241,231,.62);font-size:11px;line-height:1.7}.account-note strong{color:var(--cream)}.account-bottom{padding-top:20px;color:rgba(247,241,231,.35);font:800 7px Arial,sans-serif;letter-spacing:.15em;text-transform:uppercase}.account-bottom b{color:var(--orange)}
      ...
      <div className="account-shell">
        <header className="account-top">
          <Link to="/" className="account-brand" aria-label="WEARO home"><span className="account-mark">W</span><span><strong>WEARO.</strong><small>AI FASHION / 2026</small></span></Link>
        ...
        <footer className="account-bottom"><b>●</b> SYSTEM ONLINE / CUSTOMER ACCOUNT / WEARO 2026</footer>
      </div>
    </main>
  );
}