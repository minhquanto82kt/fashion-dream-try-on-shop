          ...
          {user ? (
            ...
            <div className="account-auth-grid">
              ...
              <div className="account-card">
                ...
                <button className="account-google" type="button" onClick={signInWithGoogle} disabled={loading}><img src="/brand/google-g.svg" alt="Google"/><span>Continue with Google</span></button>
