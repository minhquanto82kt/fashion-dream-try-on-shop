...
export const Route = createFileRoute("/")({
  head: () => ({ meta: [
    ...
    { property: "og:image", content: DEFAULT_CONTENT.social_image_url ?? HERO }, { name: "twitter:image", content: DEFAULT_CONTENT.social_image_url ?? HERO },
  ] }),
  component: Index,
});
...
function Index() {
  ...
  return <div className="min-h-screen fashion-site">
    {content.announcement_enabled && content.announcement_text && <div style={{ background: "#F0A500", color: "#111", padding: "7px 16px", textAlign: "center", fontSize: "9px", fontWeight: 900, letterSpacing: ".08em", textTransform: "uppercase" }}>{content.announcement_text}</div>}
    <SiteNav />
