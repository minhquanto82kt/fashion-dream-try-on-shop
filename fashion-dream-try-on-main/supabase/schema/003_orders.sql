...
-- Schema reference snapshot: orders / order_items
-- Supabase project: oazipcrbutizdncctkcg
-- Branch: feature/product-admin
-- IMPORTANT: Reference only. Production history remains the existing migrations.
...
-- Orders/order_items are intentionally not publicly readable.
-- Customer order creation is handled by the existing atomic order flow, not direct public INSERT.