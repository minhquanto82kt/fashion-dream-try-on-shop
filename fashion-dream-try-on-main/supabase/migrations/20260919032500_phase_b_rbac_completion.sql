-- Complete Phase B RBAC: explicit customer role assignment and scoped back-office capabilities.
...
-- Managers use a scoped RPC instead of broad UPDATE access to orders.
